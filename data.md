...
*   [likaia/mise\_gui](https://github.com/likaia/mise_gui) - 一个面向开发者的 mise 可视化管理软件，通过图形化界面快速管理本地工具链版本以及项目内所依赖工具版本。
...
*   [TommyMerlin/ANotify](https://github.com/TommyMerlin/ANotify) - A tool for sending notifications through various messaging services. 通知发送工具，支持企业微信、飞书、钉钉、Gotify、Ntfy、Server酱、IYUU、AnPush、息知、传息、WPush、PushPlus、Reminder、巴法云、TG Bot、Email、Resend
...
*   [HDCodePractice/WangWangBot](https://github.com/HDCodePractice/WangWangBot) - 汪汪Bot是一个Telegram Bot，用于帮助你管理一台服务器上的Docker
...
*   [mrvivacious/PorNo-\_Porn\_Blocker](https://github.com/mrvivacious/PorNo-_Porn_Blocker) - redirects you from porn to positive, fulfilling websites. chrome extension + android app
...
*   [xiajingren/xhznl-todo-list](https://github.com/xiajingren/xhznl-todo-list) - :sparkles: 一个使用electron + vue + electron-builder开发的跨平台todolist（便签）桌面应用
...
*   [xheiop/trans-client-server](https://github.com/xheiop/trans-client-server) -

*   [xheiop/trans-client](https://github.com/xheiop/trans-client) -
...
*   [sagan/ptool](https://github.com/sagan/ptool) - 自用的 PT (private tracker) 全自动刷流、辅种、辅助工具
...
*   [kuoruan/Build-Armbian](https://github.com/kuoruan/Build-Armbian) - Build Armbian for Phicomm N1
